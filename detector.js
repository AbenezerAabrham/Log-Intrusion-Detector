...
// Optimization: Pre-calculate pattern entries for faster iteration in the loop
const PATTERN_ENTRIES = Object.entries(PATTERNS);

// Optimization: Hoist static regexes to avoid re-creation on every function call
...
function analyzeLogs(rawText) {
  ...
  // Optimization: Split lines and use standard for loop to avoid filter() overhead
