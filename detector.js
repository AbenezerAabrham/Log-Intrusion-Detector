...
// Hoist static values and regexes to top level for performance
...
function analyzeLogs(rawText) {
  ...
  // Use standard for loop for better performance over forEach/filter
  ...
  for (let i = 0, ipLen = ipStatsEntries.length; i < ipLen; i++) {
