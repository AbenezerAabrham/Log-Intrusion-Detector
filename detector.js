...
// Hoisted for performance to avoid re-creation and repeat Object.entries calls
...
function analyzeLogs(rawText) {
  ...
  // Using standard for-loops for performance (replaces .forEach)
  for (let i = 0; i < lines.length; i++) {
    ...
    // Regex Check 1: Iterating over defined patterns using hoisted PATTERN_ENTRIES
