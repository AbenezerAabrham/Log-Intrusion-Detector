...
// Hoisted static regular expressions and pre-flattened pattern entries to prevent repeated allocations
...
function analyzeLogs(rawText) {
  ...
  // Avoid intermediate split-filter array allocation by checking line length in-loop
  ...
  // Use index-based sequential for loop for optimal performance
  for (let i = 0; i < rawLines.length; i++) {
    ...
    // Basic extraction with fast unary + conversion for status code
