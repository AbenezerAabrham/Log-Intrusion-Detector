...
// Hoisted static regexes and pre-flattened pattern entries to avoid recreation on each log scan
...
function analyzeLogs(rawText) {
  ...
  // Single split pass without creating intermediate array allocations from .filter()
  ...
  for (let i = 0; i < rawLines.length; i++) {
    ...
    // Regex Check 1: Iterating over defined patterns using fast sequential index loop
