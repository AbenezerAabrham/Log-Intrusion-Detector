...
// Hoisting static regular expressions and pre-flattening threat signatures
// to avoid re-creation and object entry allocations inside the high-frequency line parsing loop.
...
function analyzeLogs(rawText) {
  ...
  const patternCount = PATTERN_ENTRIES.length;

  // Optimized single-pass line parser
  for (let i = 0; i < rawLines.length; i++) {
    ...
    // Check pre-flattened threat signature patterns using fast sequential loop
