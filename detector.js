...
// Hoisted for performance to avoid re-calculating or re-creating in every analysis call/loop
...
function analyzeLogs(rawText) {
  ...
  // Single-pass processing of lines using a standard for loop for peak performance
  for (let i = 0, len = lines.length; i < len; i++) {
    ...
    // basic extraction using hoisted regex
