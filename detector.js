...
// Hoist static entries and regexes to avoid repeated object creation and compilation during analysis
...
function analyzeLogs(rawText) {
  ...
  // Use standard for loop for performance - significantly faster than .forEach for large logs
  for (let index = 0; index < lines.length; index++) {
    ...
    // Using pre-calculated entries to avoid Object.entries() call inside the hot loop
