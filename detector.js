...
// Pre-compute pattern entries and static regexes to optimize loop performance
const PATTERN_ENTRIES = Object.entries({
  sqli: {
...
// Re-expose PATTERNS for compatibility with any existing external references
const PATTERNS = Object.fromEntries(PATTERN_ENTRIES);
...
function analyzeLogs(rawText) {
  ...
  // Optimized loop using standard for-loop and hoisted regexes/entries
  for (let i = 0; i < lines.length; i++) {
    ...
    // Regex Check 1: Iterating over pre-computed pattern entries
