...
// Hoisted for performance to avoid re-creation and object entry overhead in tight loops
...
/**
 * Analyzes raw log text for security threats.
 * Optimized with hoisted regex and standard loops for high-performance log processing.
 */
function analyzeLogs(rawText) {
  ...
  // Split lines but avoid .filter() to save an intermediate array and extra pass
  ...
  // Standard for-loop is significantly faster than .forEach for large arrays
  for (let i = 0, len = lines.length; i < len; i++) {
    ...
    // Regex Check 1: Iterating over pre-calculated PATTERN_ENTRIES
