...
// Hoisted constants for optimized regex evaluation and pattern iteration
...
function analyzeLogs(rawText) {
  ...
  // Bolt optimization: Single split pass, avoiding intermediate filter array allocation
  ...
  // Bolt optimization: Sequential index-based loop over lines
  for (let i = 0; i < lines.length; i++) {
    ...
    let flaggedReasons = null; // Lazy-allocated to reduce GC overhead
    
    // Bolt optimization: Fast regex match with hoisted expressions & fast unary '+'
    ...
    // Bolt optimization: Iterating over hoisted PATTERN_ENTRIES with index loop
