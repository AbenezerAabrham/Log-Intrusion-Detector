...
// Hoisted regex and entries to avoid recreation/lookups in loops
...
function analyzeLogs(rawText) {
  ...
  // Standard for loop is faster than forEach for large arrays
  for (let i = 0, len = lines.length; i < len; i++) {
    ...
    // Using for loop instead of forEach for pattern matching
