...
// Hoist static regexes and pattern entries to avoid repeated creation in analyzeLogs
...
function analyzeLogs(rawText) {
  ...
  // Use standard for loops and avoid intermediate array creation via .filter()
