...
// Hoist regexes and pattern entries to avoid repeated creation and object property lookups in hot path
...
function analyzeLogs(rawText) {
  ...
  // Use standard for-loop for performance (avoids function call overhead of forEach)
