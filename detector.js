...
// Hoist constants and pre-calculate entries to avoid overhead in the hot path
...
function analyzeLogs(rawText) {
  ...
  // Use a standard for loop for maximum performance over large log files
  for (let i = 0; i < lines.length; i++) {
    ...
    // Regex Check 1: Iterating over pre-hoisted pattern entries
