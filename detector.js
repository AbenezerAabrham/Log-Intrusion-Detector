...
// Hoist static entries and regexes to avoid re-calculating/re-creating them in the analysis loop
...
function analyzeLogs(rawText) {
  ...
  // Use a standard for loop for better performance over large datasets
