...
// Hoist regexes and entries to avoid repeated creation/conversion during analysis
...
function analyzeLogs(rawText) {
  ...
  // Avoid intermediate array creation by not filtering empty lines here
  ...
  // Optimization: use standard for loops and cached lookups
  for (let i = 0, len = rawLines.length; i < len; i++) {
    ...
    // Optimization: use pre-calculated entries and standard for loop
