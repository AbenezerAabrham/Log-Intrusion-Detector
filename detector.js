...
// Optimization: Hoist static regexes and pre-calculate pattern entries outside the hot loop
...
function analyzeLogs(rawText) {
  ...
  // Optimization: Use standard for loop to avoid forEach overhead and split/filter overhead
  for (let i = 0; i < lines.length; i++) {
    ...
    // Optimization: Cache ipStats lookup to minimize property access
    ...
    // Optimization: Use pre-calculated PATTERN_ENTRIES and standard for...of loop
